...
public final class TutorialManager {
    ...
    public void onPlayerReady(Player player) {
        ...
        Nexus.getInstance().getNexusHudSystem().showTutorialStep(store.getComponent(ref, Player.getComponentType()), first);
    }
    ...
    private void advance(Ref<EntityStore> ref, CommandBuffer<EntityStore> cmd) {
        ...
        store.getExternalData().getWorld().execute(() -> {
            ...
            Nexus.getInstance().getNexusHudSystem().showTutorialStep(player, nextStep);
        });
    }
    ...
    private void complete(Ref<EntityStore> ref, CommandBuffer<EntityStore> cmd) {
        ...
        ref.getStore().getExternalData().getWorld().execute(() -> {
            ...
            if (player != null) Nexus.getInstance().getNexusHudSystem().hideTutorial(player);
        });
    }
