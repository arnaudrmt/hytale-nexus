 ...
 * those events when the <em>attacker</em> carries {@link FrozenComponent}.
 * <p>
 ...
 * {@link FrozenComponent}, not the target.
 */
public final class BreachFreezeAttackInterceptor extends DamageEventSystem {
    ...
    public void handle(int index, @NonNullDecl ArchetypeChunk<EntityStore> chunk,
        ...
        FrozenComponent frozen = store.getComponent(attackerRef, FrozenComponent.getComponentType());
