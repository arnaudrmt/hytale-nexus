...
public final class StrikeSwapConfirmedComponent implements Component<EntityStore> {
    ...
    public static ComponentType<EntityStore, StrikeSwapConfirmedComponent> getComponentType() {
        if (componentType == null)
            throw new IllegalStateException(MessageUtil.componentNotRegistered(StrikeSwapConfirmedComponent.class.getSimpleName()));
    ...
    @Override
    @NonNullDecl
    public StrikeSwapConfirmedComponent clone() {
        return new StrikeSwapConfirmedComponent();
    }
}
