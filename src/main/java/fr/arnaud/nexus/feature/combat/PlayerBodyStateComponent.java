 ...
 * Used by the movement system for speed-based FOV sampling.
 */
public final class PlayerBodyStateComponent implements Component<EntityStore> {
    ...
    public static ComponentType<EntityStore, PlayerBodyStateComponent> getComponentType() {
        if (componentType == null)
            throw new IllegalStateException(MessageUtil.componentNotRegistered(PlayerBodyStateComponent.class.getSimpleName()));
