...
public final class NexusHud extends CustomUIHud {
    ...
    public void showWave(int currentWave, int totalWaves, int killed, int total) {
        ...
        cmd.set("#WaveLabel.TextSpans",
            Message.raw(String.format(Locale.ROOT, Message.translation("nexus.spawner.wave").getRawText() + " %d / %d", currentWave, totalWaves)));
    ...
    public void showWaveComplete() {
        ...
        cmd.set("#WaveLabel.TextSpans", Message.translation("nexus.spawner.wave.complete"));
