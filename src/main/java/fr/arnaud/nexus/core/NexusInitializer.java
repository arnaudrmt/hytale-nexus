...
import fr.arnaud.nexus.ability.dash.DashComponent;
import fr.arnaud.nexus.ability.dash.DashSystem;
import fr.arnaud.nexus.ability.strike.*;
...
public final class NexusInitializer {
    ...
    private void registerComponents() {
        ...
        // Movement
        PlayerOrientationComponent.setComponentType(registry.registerComponent(PlayerOrientationComponent.class, PlayerOrientationComponent::new));
    ...
    private EntityEventSystem<EntityStore, InventoryChangeEvent> buildItemDurabilityRestoreSystem() {
        return new EntityEventSystem<>(InventoryChangeEvent.class) {
            @Override
            public void handle(int index, @NotNull ArchetypeChunk<EntityStore> chunk, @NotNull Store<EntityStore> store,
                               @NotNull CommandBuffer<EntityStore> cmd, @NotNull InventoryChangeEvent event) {
