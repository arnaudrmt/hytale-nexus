...
import fr.arnaud.nexus.ability.strike.StrikeComponent;
...
public final class PlayerSessionListener {
    ...
    public static void onPlayerReady(@NonNullDecl PlayerReadyEvent event) {
        ...
        Transform returnLocation = transform != null
            ...
            : new Transform(new Vector3d(0.5, 80.0, 0.5), new Vector3f(0f, CameraPacketBuilder.ISO_CAMERA_YAW_RAD, 0f));
    ...
    private static void attachPlayerComponents(@NonNullDecl Ref<EntityStore> ref,
        ...
        // Movement
        store.putComponent(ref, PlayerOrientationComponent.getComponentType(), new PlayerOrientationComponent());
