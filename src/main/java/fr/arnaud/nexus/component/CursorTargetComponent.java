 ...
 */
public final class CursorTargetComponent implements Component<EntityStore> {
    ...
    @Nullable
    private static ComponentType<EntityStore, CursorTargetComponent> componentType;

    @NonNullDecl
    public static ComponentType<EntityStore, CursorTargetComponent> getComponentType() {
        if (componentType == null) throw new IllegalStateException("CursorTargetComponent not registered.");
        return componentType;
    }

    public static void setComponentType(@Nullable ComponentType<EntityStore, CursorTargetComponent> type) {
        componentType = type;
    }

    @Override
    @NonNullDecl
    public CursorTargetComponent clone() {
        CursorTargetComponent c = new CursorTargetComponent();
